...
_Source artifact: `product/inputs/reference/arc-ideation-readme.md`. Generated by context-ingest; do not hand-edit._
...
| Change or add an architecture decision | `decisions/` -- see rules below |
...
A generated HTML overview lives at `../../output/scribl-engagement-overview.html` (local-only, regenerate with `/arc-overview`).
