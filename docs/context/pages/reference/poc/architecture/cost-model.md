---
title: "Project Information: pages/reference/poc/architecture/cost-model"
---

<!-- Generated by docs-sync from `product/context/pages/reference/poc/architecture/cost-model.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl D2C -- Infrastructure Cost / TCO Model

_Source artifact: `product/inputs/reference/poc/architecture/cost-model.md`. Generated by context-ingest; do not hand-edit._

Source of truth: `Scribl-D2C-AWS-Estimate-v3.xlsx`
