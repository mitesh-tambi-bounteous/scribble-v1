---
title: "Project Information: pages/reference/decisions/0010-async-ai-pipeline"
---

<!-- Generated by docs-sync from `product/context/pages/reference/decisions/0010-async-ai-pipeline.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0010: Drawing interpretation and moderation run async; submit never blocks on AI

_Source artifact: `product/inputs/reference/decisions/0010-async-ai-pipeline.md`. Generated by context-ingest; do not hand-edit._
