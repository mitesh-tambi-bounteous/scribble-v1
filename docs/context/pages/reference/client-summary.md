---
title: "Project Information: pages/reference/client-summary"
---

<!-- Generated by docs-sync from `product/context/pages/reference/client-summary.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl -- Client Summary

_Source artifact: `product/inputs/reference/client-summary.md`. Generated by context-ingest; do not hand-edit._
