---
title: "Project Information: pages/reference/poc/architecture/README"
---

<!-- Generated by docs-sync from `product/context/pages/reference/poc/architecture/README.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl D2C -- AWS Architecture

_Source artifact: `product/inputs/reference/poc/architecture/README.md`. Generated by context-ingest; do not hand-edit._
...
- **Diagram (PNG):** `Scribl_AWS_Architecture_D2C.png` -- the canonical visual.
- **Cost model (xlsx):** `Scribl-D2C-AWS-Estimate-v3.xlsx` -- the 30-month TCO model and source of truth for all cost figures below.

![Scribl D2C AWS Architecture](/assets/context/reference-poc-architecture-scribl-aws-architecture-d2c.png)
...
Distilled from `Scribl-D2C-AWS-Estimate-v3.xlsx`
