---
title: "Project Information: pages/reference/architecture-plan"
---

<!-- Generated by docs-sync from `product/context/pages/reference/architecture-plan.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Architecture plan

_Source artifact: `product/inputs/reference/architecture-plan.md`. Generated by context-ingest; do not hand-edit._
...
- Architecture decisions -- the ADRs (0001 through 0011) that back
